      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_380px]">
              ...
              <li key={i.productId} className="flex gap-4 py-6">
                ...
                <div className="flex flex-1 flex-col gap-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    {formatUSD(unit)} / unit &middot; {formatGEL(unit)}
                  </div>
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-muted-foreground">{formatGEL(unit * i.quantity)}</div>
                    </div>
                  </div>
                </div>
              </li>
        ...
        <aside className="h-fit surface-card p-6">
          ...
          <div className="mt-4 space-y-2 text-sm">
            ...
            <div className="flex justify-end text-xs text-muted-foreground">{formatGEL(subtotal)}</div>
          ...
          <div className="flex items-baseline justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-muted-foreground">{formatGEL(subtotal)}</div>
            </div>
          </div>
