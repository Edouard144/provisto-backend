          ...
          {user ? (
            <div className="flex items-center gap-2">
              {user.role === "admin" && (
                <Link
                  to="/admin"
                  className="hidden h-10 items-center gap-2 rounded-full border border-terracotta/30 bg-terracotta/10 px-4 text-sm font-medium text-terracotta hover:bg-terracotta/20 md:flex"
                >
                  Dashboard
                </Link>
              )}
